...
# MODIFIED SIGNATURE: Added custom_sub_path, sub_mode, custom_quality
async def encode(filepath, message, msg, audio_map=None, custom_sub_path=None, sub_mode=None, custom_quality=None):
    ...
    # 🔴 MODIFIED: Subtitle Logic (Handles custom subtitles & interactive inputs)
    ...
    # 🔴 MODIFIED: Watermark and Resolution (Handles interactive custom_quality)
    ...
    if a_i == []:
        ...
        if audio_map:
            ...
            # Explicitly set the default disposition for the first audio stream
...
# =========================================================
# 🔴 NEWLY ADDED: FONT HANDLERS (ADMIN/OWNER ONLY)
# =========================================================
...
async def is_admin(user_id):
    ...
    if sudo_users and str(user_id) in sudo_users: 
        return True
    return False
...
# =========================================================
# 🔴 NEWLY ADDED: INTERACTIVE ENCODE WORKFLOW
# =========================================================

@Client.on_message((filters.command("encode") | filters.document) & filters.private)
...
@Client.on_callback_query(filters.regex(r"^qual_(OG|2160|1080|720|480)$"))
